...
% Mask: (n x P) mask denoting which observations are unknown   表示掩模其中观察是未知
% sigma: residual error stopping criterion, normalized by signal norm  残余误差停止准则，由信号范数归一化
% rc_min: minimal residual correlation before stopping
% max_coeff: maximal number of non-zero coefficients for signal 用于信号的非零系数的最大数目
%
% Output
% A: OMP coding
